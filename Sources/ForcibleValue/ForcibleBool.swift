    ...
    if let bool = try? container.decode(Bool.self) {
      ...
      throw DecodingError.typeMismatch(
        ...
        DecodingError.Context(
          codingPath: container.codingPath,
          debugDescription:
            "Could not decode incoming value to Bool. It is not a type of Bool, Int or String."
        )
      )
    }
  }
...
extension KeyedDecodingContainer {
  public func decode(_ type: ForcibleBool.Option.Type, forKey key: Key) throws
    -> ForcibleBool.Option
  {
